...
:root {
  --menu-base: <?=$css['menu_background'][1]?>;
  --menu-point: <?=$css['menu_text'][2]?>;
  --menu-text: <?=$css['menu_text'][0]?>;
  --position: <?if(strpos($css['menu_style'][0], 'calc') === 0) echo $css['menu_style'][0]; else echo $css['menu_style'][0].'px';?>;
}
...
.mobilebtn {
  position: fixed;
  top: 20px;
  <?if($css['menu_style'][1] == 'right') echo 'right'; else echo 'left';?>: 20px;
  width: 32px;
  height: 32px;
...
#header {
  ...
  top: 0;
  <?if($css['menu_style'][1] != 'center') echo $css['menu_style'][1];?>: 0;
  <?if($css['menu_style'][1] == 'right') echo 'left'; else echo 'right';?>: unset;
  z-index: 99;
  pointer-events: none;
}
...
.widgetmenu {
  ...
  position: absolute;
  margin-top: 50vh;
  <?if($css['menu_style'][1] != 'center') echo $css['menu_style'][1]; else echo 'top'?>: var(--position);
...
.widgetmenu.view {
  <?if($css['menu_style'][1] != 'center') echo $css['menu_style'][1]; else echo 'top'?>: var(--position) !important;
}
.widgetmenu ul {
  display: flex;
  flex-direction: column;
  <?if($css['menu_style'][1] == 'right') echo 'align-items: flex-end;'?>
}
.widgetmenu_list {
  position: relative;
  display: block;
...
.widget_a {
  ...
  align-items: center;
  <?if($css['menu_style'][1] == 'right') echo 'flex-direction: row-reverse;';?>
  position: relative;
}
.widgetmenu_item {
}
.widgetmenu_item_icon {
  width: 24px;
  height: 24px;
  <?if($css['menu_style'][1] == 'left' || $css['menu_style'][1] == 'center') echo 'left'; else echo 'right';?>: 1px;
  position: relative;
  overflow: hidden;
  display: inline-flex;
  align-items: center;
...
@media all and (min-width: 1001px) { 
 ...
 @media all and (max-width: 1000px) {
  ...
  .widgetmenu {
    <?if($css['menu_style'][1] == 'right') echo 'right'; else echo 'left';?>: -200%;
  }
  .widgetmenu.view {
    <?if($css['menu_style'][1] == 'right') echo 'right'; else echo 'left';?>: 20px !important;
  }
...
.simple .widgetmenu_item_text {
  text-align: <?if($css['menu_style'][1] == 'center' || $css['menu_style'][1] == 'left') echo 'right'; else echo 'left';?>;
...
.simple .widgetmenu_main_havesub::after {
  ...
  font-family: impact;
  position: absolute;
  <?if($css['menu_style'][1] == 'right') echo 'left'; else echo 'right';?>: -6px;
  top: calc(50% - 9px);
  z-index: 2;
  background: var(--menu-point);
  color: var(--menu-base);
...
.simple .widgetmenu_sub {
  background: var(--menu-point);
  <?if($css['menu_style'][1] != 'center') echo $css['menu_style'][1];?>: 20px;
  width: calc(100% - 20px);
  display:none;
}
...
.digital .widgetmenu_sidewindow {
  ...
  background: var(--menu-base);
  border: 2px inset var(--menu-base);
  <?if($css['menu_style'][1] == 'left') echo 'right'; else if($css['menu_style'][1] == 'right') echo 'left'; else echo 'bottom'?>: -100%;;
  top: 144px;
  min-height: 90px;
  padding-top: 30px;
  display: flex;
...
.retro .widgetmenu_item_text {
  ...
  text-align: <?if($css['menu_style'][1] != 'center') echo $css['menu_style'][1]; else echo 'left';?>;
  position: relative;
  <?if($css['menu_style'][1] != 'center') echo $css['menu_style'][1]; else echo 'left';?>: 20px;
}
...
.retro .widgetmenu_item_text::before {
  content: '<?if($css['menu_style'][1] == 'right'){
    echo '«';
  } else echo '»';?>';
  position: absolute;
  color: var(--menu-point);
  -webkit-text-fill-color: var(--menu-point);
  <?if($css['menu_style'][1] != 'center') echo $css['menu_style'][1]; else echo 'left';?>: -12px;
}
...
.iconic .widgetmenu_item {
  ...
  align-items: center;
  height: 24px;
  <?if($css['menu_style'][1] == 'right') echo 'justify-content: flex-end;'; else echo 'justify-content: flex-start;'?>
}

.iconic .widgetmenu_item_icon {
  <?if($css['menu_style'][1] == 'left' || $css['menu_style'][1] == 'center') echo 'left'; else echo 'right';?>: 0px;
  margin-<?if($css['menu_style'][1] == 'left' || $css['menu_style'][1] == 'center') echo 'right'; else echo 'left';?>: 10px;
}
...
.iconic .widgetmenu_main_havesub::after {
  content: '';
  <?if($css['menu_style'][1] == 'right') echo 'left'; else echo 'right';?>: -5px;
  top: calc(50% - 6px);
  position: absolute;
  width: 0px;
  height: 0px;
  border-<?if($css['menu_style'][1] == 'right') echo 'right'; else echo 'left';?>: 6px solid var(--menu-point);
  border-<?if($css['menu_style'][1] == 'right') echo 'left'; else echo 'right';?>: 5px solid transparent;
...
.iconic .widgetmenu_sidewindow {
  ...
  transition-duration: var(--animation-length);
  position: absolute;
  <?if($css['menu_style'][1] != 'center') echo 'left'; else echo $css['menu_style'][1];?>: calc(100% + -5px);
  top: -30px;
...
.iconic_circle .widgetmenu_item_icon {
  ...
  border-radius: 100%;
  margin-bottom: -12px;
  margin-<?if($css['menu_style'][1] == 'right') echo 'left'; else echo 'right';?>: -38px;
}
...
.iconic_circle .widgetmenu_item_text {
  ...
  display: none;
  position: relative;
  <?if($css['menu_style'][1] == 'right') echo 'right'; else echo 'left';?>: 50px;
  top: 7px;
}
...
.iconic_circle .widgetmenu_main_havesub::before {
  ...
  position: absolute;
  top: 12px;
  <?if($css['menu_style'][1] != 'center') echo $css['menu_style'][1];?>: 32px;
  width: 16px;
  font-size: 12px;
  height: 16px;
  border-radius: 100%;
...
.iconic_circle .widgetmenu_side_item_text {
  ...
  white-space: nowrap;
  <?if($css['menu_style'][1] == 'right') echo 'right'; else echo 'left';?>: 50px;
  <?if($css['menu_style'][1] == 'right') echo 'margin-right: -34px;'; else echo 'margin-left: -38px;'?>
  display: none;
}
...
.gothic .widgetmenu_main_havesub .widget_a::after {
    content: '+';
    <?if($css['menu_style'][1] == 'right') echo 'left'; else echo 'right'?>: 30px;
    position: absolute;
}
